...
.section-header { font-size: 15px !important; font-weight: 700 !important; color: #1a2050 !important; margin-bottom: 0.6rem !important; }
[data-testid="stFileUploader"] { background: #f4f6fb !important; border-radius: 10px !important; border: 1.5px dashed #b0bae8 !important; padding: 0.7rem 1rem !important; }
[data-testid="stFileUploader"] label { display: none !important; }
[data-testid="stFileUploaderDropzone"] button { background: #3b5bff !important; color: #ffffff !important; border-radius: 8px !important; border: none !important; font-weight: 700 !important; font-size: 14px !important; padding: 6px 20px !important; }
.file-success { background: #eafaf1 !important; border: 1px solid #b2dfdb !important; border-radius: 8px !important; padding: 0.5rem 1rem !important; color: #1a7a4a !important; font-size: 14px !important; font-weight: 600 !important; margin-top: 0.5rem !important; }
.card-title { font-size: 15px !important; font-weight: 700 !important; color: #1a2050 !important; margin-bottom: 0.5rem !important; }
.btn-settings .stButton > button, .btn-run .stButton > button { background: #f4f6fb !important; color: #3a3f5c !important; border: 1.5px solid #c8cfe8 !important; border-radius: 20px !important; font-family: 'Noto Sans KR', sans-serif !important; font-size: 14px !important; font-weight: 700 !important; padding: 6px 22px !important; min-height: 36px !important; width: 100% !important; cursor: pointer !important; box-shadow: 0 1px 4px rgba(60,80,180,0.07) !important; transition: background 0.15s !important; }
.btn-settings .stButton > button:hover, .btn-run .stButton > button:hover { background: #e0e5f7 !important; color: #3b5bff !important; border-color: #3b5bff !important; }
[data-testid="stTabs"] [role="tablist"] { gap: 6px !important; border-bottom: 2px solid #dde2ef !important; }
[data-testid="stTabs"] [role="tab"] { font-family: 'Noto Sans KR', sans-serif !important; font-size: 16px !important; font-weight: 800 !important; color: #7a84b3 !important; background: #f4f6fb !important; border-radius: 8px 8px 0 0 !important; padding: 6px 18px !important; border: none !important; min-width: 44px !important; }
[data-testid="stTabs"] [role="tab"][aria-selected="true"] { color: #3b5bff !important; background: #eaedfc !important; border-bottom: 2px solid #3b5bff !important; }
.filter-section-title { font-size: 13px !important; font-weight: 700 !important; color: #3b5bff !important; margin: 0.7rem 0 0.2rem 0 !important; }
div[role="tabpanel"] [data-testid="stNumberInput"] { max-width: 200px !important; }
div[role="tabpanel"] .stButton > button { background: #3b5bff !important; color: #fff !important; border-radius: 8px !important; border: none !important; font-weight: 700 !important; font-size: 14px !important; padding: 6px 22px !important; margin-top: 0.5rem !important; }
.result-title { font-size: 15px !important; font-weight: 700 !important; color: #1a2050 !important; margin-bottom: 0.5rem !important; }
[data-testid="stDataFrame"] { border-radius: 10px !important; overflow: visible !important; }
[data-testid="stDataFrame"] [data-testid="stDataFrameToolbar"] { display: flex !important; visibility: visible !important; opacity: 1 !important; }
</style>
...
with st.container(border=True):
    ...
    with col_set:
        ...
        if st.button("키워드설정", key="toggle_settings"):
...
if st.session_state.show_settings:
    with st.container(border=True):
        st.markdown('<p class="card-title">키워드 필터 설정</p>', unsafe_allow_html=True)
